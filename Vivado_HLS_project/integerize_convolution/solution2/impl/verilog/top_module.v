...
(* CORE_GENERATION_INFO="top_module,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a35t-cpg236-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.429000,HLS_SYN_LAT=1491721,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=768,HLS_SYN_LUT=1180,HLS_VERSION=2019_1}" *)
...
wire   [7:0] zext_ln16_fu_219_p1;
reg   [7:0] zext_ln16_reg_529;
wire    ap_CS_fsm_state2;
wire   [6:0] i_fu_229_p2;
reg   [6:0] i_reg_537;
wire   [14:0] sub_ln32_fu_259_p2;
reg   [14:0] sub_ln32_reg_542;
wire   [0:0] icmp_ln11_fu_223_p2;
wire   [7:0] zext_ln17_fu_265_p1;
reg   [7:0] zext_ln17_reg_547;
...
wire   [0:0] icmp_ln20_fu_281_p2;
wire   [15:0] zext_ln22_fu_323_p1;
reg   [15:0] zext_ln22_reg_573;
wire   [14:0] add_ln32_fu_331_p2;
reg   [14:0] add_ln32_reg_578;
...
wire   [63:0] zext_ln26_1_fu_371_p1;
wire  signed [63:0] sext_ln32_fu_512_p1;
wire    ap_CS_fsm_state13;
wire   [13:0] tmp_1_fu_235_p3;
wire   [8:0] tmp_2_fu_247_p3;
wire   [14:0] zext_ln32_fu_243_p1;
wire   [14:0] zext_ln32_1_fu_255_p1;
wire   [4:0] tmp_5_fu_297_p3;
wire   [5:0] zext_ln215_fu_293_p1;
wire   [5:0] zext_ln215_1_fu_305_p1;
wire   [14:0] tmp_6_fu_315_p3;
wire   [14:0] zext_ln32_2_fu_327_p1;
wire   [5:0] zext_ln215_2_fu_348_p1;
wire   [5:0] add_ln215_1_fu_352_p2;
wire   [15:0] zext_ln26_fu_362_p1;
wire   [15:0] add_ln26_fu_366_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln22_fu_336_p2 == 1'd1))) begin
        convolute_2_reg_146 <= convolute_3_reg_179;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln20_fu_281_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln20_fu_281_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        zext_ln22_reg_573[14 : 7] <= zext_ln22_fu_323_p1[14 : 7];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln20_fu_281_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln16_reg_529[6 : 0] <= zext_ln16_fu_219_p1[6 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        zext_ln17_reg_547[6 : 0] <= zext_ln17_fu_265_p1[6 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln11_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        sub_ln32_reg_542[14 : 2] <= sub_ln32_fu_259_p2[14 : 2];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln22_fu_336_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln22_fu_336_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else begin
...
assign add_ln26_fu_366_p2 = (zext_ln22_reg_573 + zext_ln26_fu_362_p1);

assign add_ln32_fu_331_p2 = (zext_ln32_2_fu_327_p1 + sub_ln32_reg_542);
...
assign i_fu_229_p2 = (x_reg_123 + 7'd1);

assign icmp_ln11_fu_223_p2 = ((x_reg_123 == 7'd124) ? 1'b1 : 1'b0);

assign icmp_ln13_fu_269_p2 = ((y_reg_134 == 7'd124) ? 1'b1 : 1'b0);

assign icmp_ln20_fu_281_p2 = ((k_0_reg_168 == 3'd5) ? 1'b1 : 1'b0);

assign icmp_ln22_fu_336_p2 = ((l_0_reg_200 == 3'd5) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln26_1_fu_371_p1;

assign j_fu_275_p2 = (y_reg_134 + 7'd1);
...
assign output_r_address0 = sext_ln32_fu_512_p1;
...
assign sext_ln32_fu_512_p1 = $signed(add_ln32_reg_578);

assign sub_ln1311_fu_430_p2 = (8'd127 - tmp_V_fu_398_p4);

assign sub_ln32_fu_259_p2 = (zext_ln32_fu_243_p1 - zext_ln32_1_fu_255_p1);

assign tmp_1_fu_235_p3 = {{x_reg_123}, {7'd0}};
...
assign tmp_6_fu_315_p3 = {{x_0_reg_158}, {7'd0}};
...
assign x_1_fu_382_p2 = (x_0_reg_158 + 8'd1);

assign y_2_fu_376_p2 = (y_1_reg_191 + 8'd1);

assign zext_ln1287_fu_466_p1 = $unsigned(sext_ln1311_1_fu_458_p1);

assign zext_ln16_fu_219_p1 = x_reg_123;

assign zext_ln17_fu_265_p1 = y_reg_134;
...
assign zext_ln22_fu_323_p1 = tmp_6_fu_315_p3;

assign zext_ln26_1_fu_371_p1 = add_ln26_fu_366_p2;

assign zext_ln26_fu_362_p1 = y_1_reg_191;

assign zext_ln32_1_fu_255_p1 = tmp_2_fu_247_p3;

assign zext_ln32_2_fu_327_p1 = y_reg_134;

assign zext_ln32_fu_243_p1 = tmp_1_fu_235_p3;
...
always @ (posedge ap_clk) begin
    zext_ln16_reg_529[7] <= 1'b0;
    sub_ln32_reg_542[1:0] <= 2'b00;
    zext_ln17_reg_547[7] <= 1'b0;
    zext_ln22_reg_573[6:0] <= 7'b0000000;
    zext_ln22_reg_573[15] <= 1'b0;
end
