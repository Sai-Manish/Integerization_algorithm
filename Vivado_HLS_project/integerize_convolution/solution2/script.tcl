...
config_export -format ip_catalog -rtl verilog -version 0.0.0 -vivado_optimization_level 2 -vivado_phys_opt place -vivado_report_level 0
#source "./integerize_convolution/solution2/directives.tcl"
csim_design
csynth_design
cosim_design
