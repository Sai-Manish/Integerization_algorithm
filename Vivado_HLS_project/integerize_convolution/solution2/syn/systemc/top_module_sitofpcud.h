...
// ==============================================================
#ifndef __top_module_sitofpcud__HH__
#define __top_module_sitofpcud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_module_sitofpcud) {
    ...
    SC_CTOR(top_module_sitofpcud):  ACMP_sitofp_U ("ACMP_sitofp_U") {
