...
// ==============================================================
#ifndef __top_module_mac_mudEe__HH__
#define __top_module_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_module_mac_mudEe) {
    ...
    SC_CTOR(top_module_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
