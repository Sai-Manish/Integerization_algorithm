...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {4 1 +} i1 {8 0 +} m {12 1 +} i2 {32 0 +} p {32 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 14 vector } input_r_ce0 { O 1 bit } input_r_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel_V \
    op interface \
    ports { kernel_V_address0 { O 5 vector } kernel_V_ce0 { O 1 bit } kernel_V_q0 { I 4 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_alpha_kernel \
    op interface \
    ports { alpha_kernel { I 32 vector } } \
} "
}
