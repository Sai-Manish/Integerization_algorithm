...
$(ObjDir)/integerize_convolution_test.cpp_pre.cpp.tb.o : integerize_convolution_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling integerize_convolution_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/intergerize_convolution.cpp_pre.cpp.tb.o : intergerize_convolution.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling intergerize_convolution.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
